...
namespace JLio.Core.Models
{
    public abstract class FunctionBase : IFunction
    {
        ...
        public abstract JLioFunctionResult Execute(JToken currentToken, JToken dataContext, IExecutionOptions options);
            ...
            IExecutionOptions options)
        {
            ...
            arguments.ForEach(a => argumentValues.Add(
                a.GetValue(currentToken, dataContext, options).GetJTokenValue()));
