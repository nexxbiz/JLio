...
/// <summary>
/// Find the minimum (earliest) date from multiple date values
/// </summary>
public class MinDate : FunctionBase
{
    public MinDate()
    {
    }

    public MinDate(params string[] arguments)
    {
    ...
    public override JLioFunctionResult Execute(JToken currentToken, JToken dataContext, IExecutionContext context)
    {
        ...
        return new JLioFunctionResult(true, new JValue(minDate.ToString("O")));
    }
