...
/// <summary>
/// Calculate the average date from multiple date values
/// </summary>
public class AvgDate : FunctionBase
{
    public AvgDate()
    {
    }

    public AvgDate(params string[] arguments)
    {
    ...
    public override JLioFunctionResult Execute(JToken currentToken, JToken dataContext, IExecutionContext context)
    {
        ...
        // Calculate average by converting to ticks, averaging, then back to DateTime
        var averageTicks = dates.Select(d => d.Ticks).Average();
        var avgDate = new DateTime((long)averageTicks);
        
        return new JLioFunctionResult(true, new JValue(avgDate.ToString("O")));
    }
