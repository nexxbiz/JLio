...
namespace TLio.Services
{
    ...
    //        LibraryExecutionContext executionContext, IMediator mediator)
    //    {
    ...
    //    private LibraryExecutionContext CreateScriptExecutionContext(IServiceProvider serviceProvider, Script script,
    //        IReadOnlyDictionary<string, object> input)
    //    {
    //        return new LibraryExecutionContext(serviceProvider, script, input);
    //    }
    //}
}